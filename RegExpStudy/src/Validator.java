...
public class Validator {
	...
	/**
	 * 아이디 유효성 검증 영문과숫자조합으로 8~10자 아이디 ex) bangry313
	 * 
	 * @param id
	 * @return
	 */
	public static boolean isValidId(String id) {
		...
		if (id.matches(pattern) && id.length() >= 8 && id.length() <= 10) {
			return true;
		}
		return false;
	}
	...
	/**
	 * 이메일 유효성 검증 ex) bangry313@gmail.com
	 * 
	 * @param email
	 * @return
	 */
	...
	/**
	 * 전화번호 유효성 검증 2~3자리숫자-3~4자리숫자-4자리숫자 ex) 02-1234-5678
	 * 
	 * @param number
	 * @return
	 */
	...
	/**
	 * 휴대폰번호 유효성 검증 010|011|016|017|018|019-3~4자리숫자-4자리숫자 ex) 10-9179-8707
	 * 
	 * @param number
	 * @return
	 */
	...
	/**
	 * 주민등록번호 유효성 검증 6자리숫자-1~8로 시작하는 7자리숫자 ex) 680313-1234567
	 * 
	 * @param ssn
	 * @return
	 */
	...
	/**
	 * IP주소 유효성 검증 0~255.0~255.0~255.0~255 ex) 192.168.0.28
	 * 
	 * @param ip
	 * @return
	 */
